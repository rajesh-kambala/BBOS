...
UPDATE NewProduct SET prod_name='Standard Service', 
						...
						prod_PRDescription_ES='<ul class="Bullets"><li>8 licencias de usuario estándar del Blue Book Online</li><li>Informes comerciales ilimitados de Blue Book</li><li>25 Informes Experian sobre empresa</li><li>Ver y Buscar Contactos de la Empresa</li></ul>'
