...
namespace LocalSourceImporter
{
    ...
    {
        public const string COL_PHONE = "Work Phone"; //was "Phone"
        public const string COL_FAX = "Primary Fax"; //was "Fax"
        ...
        public void Load(CsvReader csv, string type)
        {
            ...
            {
                case "P":
                    Number = csv[COL_PHONE];
                    break;
                case "F":
                    Number = csv[COL_FAX];
                    break;
                case "C":
                    if (csv.HasHeader(COL_MOBILE))
                        Number = csv[COL_MOBILE];
                    break;
            }
