...
AddCustom_Screens(ObjectName, 20, 'comm_Action', LN_New, 1, 1, RQ_NotRequired, 0, '', '', '');
AddCustom_Screens(ObjectName, 21, 'comm_EmailFax', LN_Same, 1, 1, RQ_NotRequired, 0, '', '', '');
...
AddCustom_Screens(ObjectName, 70, 'prfi_IssueDescription', LN_New, 1, 3, RQ_NotRequired, 0, '', '', '');
