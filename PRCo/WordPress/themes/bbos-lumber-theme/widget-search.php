...
class Woo_Widget_Search extends WP_Widget {
	...
	function __construct () {
		...
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'widget_woo_search', 'description' => __( 'This is a custom search widget.', 'woothemes' ) );

		/* Widget control settings. */
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'woo_search' );

		/* Create the widget. */
		parent::__construct( 'woo_search', __('Custom Search', 'woothemes' ), $widget_ops, $control_ops );
...
add_action( 'widgets_init', function(){ return register_widget("Woo_Widget_Search");}, 1 ); 
?>