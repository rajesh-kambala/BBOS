...
<%
    var sGridName = "PRCompanyServiceGrid";
    var sAddNewPage = "PRCompany/PRServiceAssign.asp";
    var sEntityCompanyIdName = "prcserpr_CompanyID";
    var sNewCaption = "Assign Services Provided";
    ...
    if (iTrxStatus == TRX_STATUS_EDIT)
    {
        if (isUserInGroup(sSecurityGroups))
        {
            ...
            var sReplicateAction = eWare.Url("PRCompany/PRCompanyReplicate.asp")+ "&RepType=7&RepId=" + comp_companyid + "&comp_CompanyId=" + comp_companyid;
