...
{    
    ...
    blkAdvertisementList = eWare.GetBlock("AdCampaignAdListDigital");
    ...
    sNewAdUrl = changeKey(eWare.Url("PRAdvertising/AdCampaignAdDigital.asp"), "pradch_AdCampaignHeaderID", AdCampaignHeaderID);
