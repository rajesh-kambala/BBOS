...
{    
    ...
    blkAdvertisementList = eWare.GetBlock("AdCampaignAdListTT");
    ...
    sNewAdUrl = changeKey(eWare.Url("PRAdvertising/AdCampaignAdTT.asp"), "pradch_AdCampaignHeaderID", AdCampaignHeaderID);
