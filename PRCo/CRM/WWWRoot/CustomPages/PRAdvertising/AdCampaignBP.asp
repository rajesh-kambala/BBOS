...
{    
    ...
    if(recAdCampaignHeader.pradch_TypeCode == "D")
    ...
    var sWhere = "pradc_AdCampaignHeaderID=" + AdCampaignHeaderID;
    var recAdvertisementList = null;
    recAdvertisementList = eWare.FindRecord("PRAdCampaign", sWhere);
    blkAdvertisementList = eWare.GetBlock("AdCampaignAdListBP");
    ...
    sNewAdUrl = changeKey(eWare.Url("PRAdvertising/AdCampaignAdBP.asp"), "pradch_AdCampaignHeaderID", AdCampaignHeaderID);
