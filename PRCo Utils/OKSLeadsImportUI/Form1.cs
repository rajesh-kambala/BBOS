...
namespace OKSLeadsImportUI
{
    public partial class Form1 : Form
    {
        ...
        private void btnImport_Click(object sender, EventArgs e)
        {
            ...
            {
                msg += "  The data WILL NOT be saved, but the exception files will be generated.";
            }
            else
            {
        ...
        public void displaySuccess(OKSImporter importer)
        {
            Invoke((MethodInvoker)delegate() {
                    ...
                    msg += " - Companies Skipped: " + importer.SkippedCount.ToString("###,##0") + "\n";
                    msg += " - Companies Inserted: " + importer.CompanyInsertedCount.ToString("###,##0") + "\n";
