	...
	var Slider = function(args) {
		...
		if (slides.length <= 1) {
			Array.prototype.forEach.call(origChildren, function (child, i) {
				var sliderInnerHTMLEl = sliderEl.querySelector("a");
				sliderInnerHTMLEl.href = sliderInnerHTMLEl.attributes["data-href"].value;
				sliderInnerHTMLEl.classList.add('iis-slide-blank');
				sliderInnerHTMLEl.innerHTML = child.outerHTML;
				sliderEl.appendChild(sliderInnerHTMLEl);
			});
			return null;
		}
