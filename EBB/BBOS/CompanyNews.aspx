<%@ Page Language="C#" MasterPageFile="~/BBOS.Master" AutoEventWireup="true" CodeBehind="CompanyNews.aspx.cs" Inherits="PRCo.BBOS.UI.Web.CompanyNews" Title="Blue Book Services" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="contentLeftSidebar" ContentPlaceHolderID="contentLeftSidebar" runat="server">
    <!-- Left nav bar  -->
    <bbos:Sidebar id="ucSidebar" runat="server" MenuExpand="1" MenuPage="6"/>

    <!-- Main  -->
    <main class="main-content tw-flex tw-flex-col tw-gap-y-4">
        <bbos:PrintHeader ID="ucPrintHeader" runat="server" Title='<% $Resources:Global, News %>' />
        ...
        <p class="page-heading"><%= Resources.Global.News %></p>
        <section>
          <div class="container">
            <div class="row g-4">
