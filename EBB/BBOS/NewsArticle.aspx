<%@ Page Language="C#" MasterPageFile="~/BBOS.Master" AutoEventWireup="true" CodeBehind="NewsArticle.aspx.cs" Inherits="PRCo.BBOS.UI.Web.NewsArticle" MaintainScrollPositionOnPostback="true" %>
            ...
            <div class="row nomargin_lr">
                ...
                <asp:Panel ID="pnlPreview" runat="server" Visible="false">
                    <div class="NewsHeadline">
                        <asp:Literal ID="litPreviewName" runat="server" />
                    </div>

                    <div class="NewsItem">
                        <asp:Literal ID="litPreviewAbstract" runat="server" />
                    </div>
                </asp:Panel>

                <div class="row nomargin_lr bbos_blue_title">
                    <asp:Literal ID="litName" runat="server" />
                </div>
                <div class="row nomargin_lr ParagraphBreak">
