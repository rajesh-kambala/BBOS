<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CompaniesRecentlyViewed.ascx.cs" Inherits="PRCo.BBOS.UI.Web.Widgets.CompaniesRecentlyViewed" %>
<div class="bbs-list-panel">
    <div class="bbs-list-panel-heading">
        <h3 style="margin-right: auto"><%=Resources.Global.MostRecentlyViewedCompanies %></h3>
