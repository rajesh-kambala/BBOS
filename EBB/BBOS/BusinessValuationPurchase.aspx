<%@ Page Language="C#" MasterPageFile="~/BBOS.Master" AutoEventWireup="true" CodeBehind="BusinessValuationPurchase.aspx.cs" Inherits="PRCo.BBOS.UI.Web.BusinessValuationPurchase" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentMain" runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
            <asp:Label ID="litMsg" runat="server" Text="<%$ Resources:Global, BusinessValuationPurchaseMsg %>" />
        </div>
    </div>
        ...
        <div class="col-md-8">
            <asp:GridView ID="gvProducts"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="<%$ Resources:Global, BusinessValuations %>" ItemStyle-CssClass="text-left" HeaderStyle-CssClass="text-nowrap text-left">
                        <ItemTemplate>
                            1
                        </ItemTemplate>
                    </asp:TemplateField>
