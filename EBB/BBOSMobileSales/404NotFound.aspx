<%@ Page Language="C#" MasterPageFile="~/BBSI.Master" AutoEventWireup="true" CodeBehind="404NotFound.aspx.cs" Inherits="PRCo.BBOS.UI.Web._04NotFound" Title="Untitled Page" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Content2" runat="server">
    <div class="row nomargin panels_box">
        <div class="panel panel-primary col-xs-12 container-fluid">
