...
USE [master]
GO
/****** Object:  StoredProcedure [dbo].[usp_ResetCRMDatabaseToBaseline]    Script Date: 08/01/2007 12:57:08 ******/
...
CREATE PROCEDURE [dbo].[usp_ResetCRMDatabaseToBaseline]
    ...
    @TargetDataFile varchar(1000),  -- No exention
...
BEGIN
    ...
    SELECT @Data = LogicalName FROM @Restore WHERE type = 'D'
